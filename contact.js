...
L.marker(Brand_office).addTo(Brand_office_map)
    .bindPopup('<b>CHI NHÁNH CÔNG TY TNHH THIẾT BỊ CÔNG NGHIỆP DKTECH VIỆT NAM</b><br><a href="https://maps.app.goo.gl/nvbsqWYV2YtZXDQJ6" target="_blank">Đường đi!</a>')
    .openPopup();

L.marker(Main_office).addTo(Main_office_map)
    .bindPopup('<b>CÔNG TY TNHH THIẾT BỊ CÔNG NGHIỆP DKTECH VIỆT NAM</b><br><a href="https://maps.app.goo.gl/4YWVVpS74heCd2My6" target="_blank">Đường đi!</a>')
    .openPopup();
